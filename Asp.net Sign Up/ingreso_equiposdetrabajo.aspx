<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ingreso_equiposdetrabajo.aspx.cs" Inherits="Asp.net_Sign_Up.ingreso_equiposdetrabajo" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <asp:GridView ID="EquiposGV" runat="server" AutoGenerateColumns="false" ShowFooter="true"
                ShowHeaderWhenEmpty="true" DataKeyNames="Codigo_teamp"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Codigo Team Project">

                        <ItemTemplate>
                            <asp:Label Text='<%# Eval("Codigo_teamp")%>' runat="server" />
                        </ItemTemplate>

                        <EditItemTemplate>
                            <asp:TextBox ID="txtCodigo_de_TeamProject" Text='<%# Eval("Codigo_teamp")%>' runat="server" />
                        </EditItemTemplate>

                        <FooterTemplate>
                            <asp:TextBox ID="txtCodigo_de_TeamProjectFooter" runat="server" />
                        </FooterTemplate>
