...
{
    public partial class ingreso_equiposdetrabajo : System.Web.UI.Page
    {
        ...
        void PopulateGridview()
        {
            ...
            MySqlDataAdapter show = new MySqlDataAdapter("SELECT * FROM teamproject", con);
            show.Fill(dtbl1);
        ...
        protected void EquiposGV_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName.Equals("Add"))
            {
                ...
                String Codigo = (EquiposGV.FooterRow.FindControl("txtCodigo_de_TeamProjectFooter") as TextBox).Text.Trim();
                String Nombre = (EquiposGV.FooterRow.FindControl("txtNombreFooter") as TextBox).Text.Trim();

                MySqlCommand insert = new MySqlCommand("Create_teamP", con);
        ...
        {
            String Codigo = (EquiposGV.Rows[e.RowIndex].FindControl("txtCodigo_de_TeamProject") as TextBox).Text.Trim();
            String Nombre = (EquiposGV.Rows[e.RowIndex].FindControl("txtNombre") as TextBox).Text.Trim();

            MySqlCommand update = new MySqlCommand("Update_teamproject", con);

            update.Parameters.Add(new MySqlParameter("P_C", Codigo));
