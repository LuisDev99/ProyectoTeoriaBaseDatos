...
{
    public partial class ingreso_equipos : System.Web.UI.Page
    {
        ...
        {
            String Codigo = (EquiposGV.Rows[e.RowIndex].FindControl("txtCodigo_de_Equipo") as TextBox).Text.Trim();
            String Nombre = (EquiposGV.Rows[e.RowIndex].FindControl("txtNombre") as TextBox).Text.Trim();
            String Supervisor = (EquiposGV.Rows[e.RowIndex].FindControl("txtSupervisor") as TextBox).Text.Trim();

            MySqlCommand update = new MySqlCommand("Update_Teams", con);

            update.Parameters.Add(new MySqlParameter("P_ID", Codigo));
            update.Parameters.Add(new MySqlParameter("P_N", Nombre));
            update.Parameters.Add(new MySqlParameter("P_S", Supervisor));
