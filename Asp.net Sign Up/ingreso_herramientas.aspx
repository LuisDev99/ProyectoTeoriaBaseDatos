<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ingreso_herramientas.aspx.cs" Inherits="Asp.net_Sign_Up.ingreso_herramientas" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <asp:GridView ID="EquiposGV" runat="server" AutoGenerateColumns="false" ShowFooter="true"
                ShowHeaderWhenEmpty="true" DataKeyNames="Id_Tool"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="ID Herramienta">
                        ...
                        <ItemTemplate>
                            <asp:Label Text='<%# Eval("Id_tool")%>' runat="server" />
                        </ItemTemplate>

                        <EditItemTemplate>
                            <asp:TextBox ID="txtCodigo_de_herramienta" Text='<%# Eval("Id_tool")%>' runat="server" />
                        </EditItemTemplate>

                        <FooterTemplate>
                            <asp:TextBox ID="txtCodigo_de_herramientaFooter" runat="server" />
                        </FooterTemplate>
                    ...
                    <asp:TemplateField HeaderText="Tipo">
                        ...
                        <EditItemTemplate>
                            <asp:TextBox ID="txtTipo" Text='<%# Eval("Tipo")%>' runat="server" />
                        </EditItemTemplate>
